package com.gear.gis.tool.util;
...
public class FeatureClassUtil {
    public static GearFeatureClass buildMemoryFeatureClass(String name, CoordinateReferenceSystem crs, List<String> fieldNameList) throws IOException {
